...
from mint_automation import automate_minting_steps # 导入自动化函数
import logging
...
def test_automation_steps():
    ...
    automate_minting_steps(YOUR_PRIVATE_KEY, RECEIVE_ADDRESS, str(GAS_FEE_RATE), keep_browser_open=True)
